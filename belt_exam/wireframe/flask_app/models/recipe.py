...
class Recipe:
    ...
    def get_by_id(cls, recipe_id):
        ...
        data = {"id": recipe_id}
        query = """SELECT recipes.id, recipes.created_at, recipes.updated_at, instructions, description, name, date_made, under,
    ...
    def get_all(cls):
        ...
        query = """SELECT 
                    recipes.id, recipes.created_at, recipes.updated_at, instructions, description, name, date_made, under,
                    users.id as user_id, first_name, last_name, email, users.created_at as uc, users.updated_at as uu
                    FROM recipes
                    JOIN users on users.id = recipes.user_id;"""
